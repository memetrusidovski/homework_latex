...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{CP312} %Nombre de la materia
\fancyhead[C]{Memet Rusidovski} % Nombre del alumno
\fancyhead[R]{rusi1550@mylaurier.ca} % Email
\fancyfoot[R]{Profesor M. Rudafshani }
% https://tex.stackexchange.com/questions/227/how-can-i-add-page-of-on-my-document
\fancyfoot[C]{\thepage\ of \pageref*{LastPage}}
%\fancyfoot[C]{ of }
\fancyfoot[L]{Student Number: 130951550} % Grupo
